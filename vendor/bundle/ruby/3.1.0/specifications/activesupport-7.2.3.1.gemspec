# -*- encoding: utf-8 -*-
# stub: activesupport 7.2.3.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/rails/rails/issues", "changelog_uri" => "https://github.com/rails/rails/blob/v7.2.3.1/activesupport/CHANGELOG.md", "documentation_uri" => "https://api.rubyonrails.org/v7.2.3.1/", "mailing_list_uri" => "https://discuss.rubyonrails.org/c/rubyonrails-talk", "rubygems_mfa_required" => "true", "source_code_uri" => "https://github.com/rails/rails/tree/v7.2.3.1/activesupport" } if s.respond_to? :metadata=
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<minitest>.freeze, [">= 5.1", "< 6"])
    ...
    s.add_dependency(%q<tzinfo>.freeze, ["~> 2.0", ">= 2.0.5"])
    s.add_dependency(%q<concurrent-ruby>.freeze, ["~> 1.0", ">= 1.3.1"])
    s.add_dependency(%q<connection_pool>.freeze, [">= 2.2.5"])
    s.add_dependency(%q<minitest>.freeze, [">= 5.1", "< 6"])
    ...
    s.add_dependency(%q<securerandom>.freeze, [">= 0.3"])
    s.add_dependency(%q<benchmark>.freeze, [">= 0.3"])
  end
end
